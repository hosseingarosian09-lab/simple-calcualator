...
clear_screan = Button(frame, text='clear', height=4, font=("Arial", 16),bg="#E8DCC6",border=2,relief="groove",width=12,command=clear)
clear_screan.grid(row=4, column=0, columnspan=4, sticky="nsew")
